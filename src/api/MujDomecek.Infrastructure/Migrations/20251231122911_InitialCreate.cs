        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GeoRadius = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ServerRevision = table.Column<long>(type: "bigint", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    PushNewComments = table.Column<bool>(type: "boolean", nullable: false),
                    PushMentions = table.Column<bool>(type: "boolean", nullable: false),
                    PushSharedActivity = table.Column<bool>(type: "boolean", nullable: false),
                    PushDraftReminders = table.Column<bool>(type: "boolean", nullable: false),
                    EmailWeeklySummary = table.Column<bool>(type: "boolean", nullable: false),
                    EmailInvitations = table.Column<bool>(type: "boolean", nullable: false),
                    SyncEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    SyncOnMobileData = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyMembers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PropertyMembers_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_Zaznamy_ZaznamId",
                        column: x => x.ZaznamId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ZaznamDokumenty", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ZaznamTags", x => new { x.ZaznamId, x.TagId });
                    table.ForeignKey(
                        name: "FK_ZaznamTags_Zaznamy_ZaznamId",
                        column: x => x.ZaznamId,
                        principalTable: "Zaznamy",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyMembers_PropertyId_UserId",
                table: "PropertyMembers",
                columns: new[] { "PropertyId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SyncQueueItems_Status_NextRetryAt",
