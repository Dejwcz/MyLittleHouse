...
namespace MujDomecek.Areas.Identity.Pages.Account.Manage {
    public class DeletePersonalDataModel : PageModel {
        ...
        public async Task<IActionResult> OnPostAsync() {
            ...
            var unitsIds = _context.Properties.
                Where(x => x.UserId == _userManager.GetUserId(User))
            ...
            var documents = _context.Properties
                .Where(x => x.UserId == _userManager.GetUserId(User))
                .SelectMany(x => x.Units)
                .SelectMany(u => u.Repairs)
            ...
            _context.RepairDocuments.RemoveRange(documents);
